...
interface RecommendationWarningModalProps {
  isOpen: boolean;
  onClose: () => void;
  onPreview: () => void;
  onSend: () => void;
...
export const RecommendationWarningModal: React.FC<RecommendationWarningModalProps> = ({
  isOpen,
  onClose,
  onPreview,
  onSend,
  ...
  const isMultiplePublishers = publisherCount > 1;
        ...
        <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-16">
                <div className="flex items-start gap-8">
                  ...
                  <div className="text-sm text-amber-800">
                    <strong>Impact:</strong> {publisherCount} publisher{publisherCount !== 1 ? 's' : ''} will receive recommendation request emails without your review.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-24 border-t border-gray-200">
            ...
            <div className="flex items-center gap-12">
              ...
              >
                {isMultiplePublishers ? 'Preview All' : 'Preview'}
              </Button>
              ...
              <Button
                ...
                icon={<Send size={16} />}
              >
                {isMultiplePublishers ? 'Send All' : 'Send'}
              </Button>
            </div>
          </div>
        </div>
